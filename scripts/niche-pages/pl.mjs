  ...
  niches: {
    "hotels-airbnb": {
      ...
      bullets: [
        ...
        "Idealne dla hoteli, Airbnb, apartamentów wakacyjnych i na wynajem",
    ...
    "roller-shutters": {
      ...
      bullets: [
        ...
        "Rzadsza wymiana zamków, kodów i pilotów",
      ],
    ...
    "electric-gates": {
      ...
      bullets: [
        ...
        "Idealne dla parkingów, budynków, firm i osiedli prywatnych",
        "Wygodne zarządzanie użytkownikami i uprawnieniami",
        "Prywatność i bezpieczeństwo dzięki dostępowi lokalnemu, bez zależności od chmury",
