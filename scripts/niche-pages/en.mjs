  ...
  niches: {
    "hotels-airbnb": {
      ...
      bullets: [
        ...
        "Suitable for hotels, Airbnb, vacation rentals, and guest apartments",
    ...
    "roller-shutters": {
      ...
      bullets: [
        ...
        "Less need to replace locks, codes, or remotes",
      ],
    ...
    "electric-gates": {
      ...
      bullets: [
        ...
        "Suitable for parking lots, buildings, businesses, and private complexes",
        "Convenient user and permission management",
        "Privacy and security with local access, no cloud dependence",
