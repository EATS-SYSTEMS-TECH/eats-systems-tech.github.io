...
var SITE_LANGUAGE_OPTIONS = [
  ...
  { code: "fr", label: "Français", flagType: "emoji", flagEmoji: "🇫🇷" },
  { code: "de", label: "Deutsch", flagType: "emoji", flagEmoji: "🇩🇪" },
  { code: "nl", label: "Nederlands", flagType: "emoji", flagEmoji: "🇳🇱" },
  { code: "it", label: "Italiano", flagType: "emoji", flagEmoji: "🇮🇹" },
  ...
  { code: "no", label: "Norsk", flagType: "emoji", flagEmoji: "🇳🇴" },
  ...
  { code: "uk", label: "Українська", flagType: "emoji", flagEmoji: "🇺🇦" },
  { code: "tr", label: "Türkçe", flagType: "emoji", flagEmoji: "🇹🇷" },
  { code: "ar", label: "العربية", flagType: "image", flagSrc: "flag-ae.svg", flagAlt: "AE" },
  { code: "hi", label: "हिन्दी", flagType: "emoji", flagEmoji: "🇮🇳" },
  { code: "bn", label: "বাংলা", flagType: "emoji", flagEmoji: "🇮🇳" },
  { code: "mr", label: "मराठी", flagType: "emoji", flagEmoji: "🇮🇳" },
  { code: "te", label: "తెలుగు", flagType: "emoji", flagEmoji: "🇮🇳" },
  { code: "zh-Hans", label: "简体中文", flagType: "emoji", flagEmoji: "🇨🇳" },
  { code: "zh-Hant", label: "繁體中文", flagType: "emoji", flagEmoji: "🇹🇼" },
  { code: "ja", label: "日本語", flagType: "emoji", flagEmoji: "🇯🇵" },
  { code: "ko", label: "한국어", flagType: "emoji", flagEmoji: "🇰🇷" },
  { code: "da", label: "Dansk", flagType: "emoji", flagEmoji: "🇩🇰" },
  { code: "hu", label: "Magyar", flagType: "emoji", flagEmoji: "🇭🇺" },
];
