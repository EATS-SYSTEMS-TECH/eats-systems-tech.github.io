...
var SITE_LANGUAGE_OPTIONS = [
  ...
  { code: "el", label: "Ελληνικά", flagType: "image", flagSrc: "flag-gr.svg", flagAlt: "GR" },
  { code: "ro", label: "Română", flagType: "image", flagSrc: "flag-ro.svg", flagAlt: "RO" },
  { code: "hr", label: "Hrvatski", flagType: "image", flagSrc: "flag-hr.svg", flagAlt: "HR" },
  { code: "fi", label: "Suomi", flagType: "image", flagSrc: "flag-fi.svg", flagAlt: "FI" },
  { code: "bg", label: "Български", flagType: "image", flagSrc: "flag-bg.svg", flagAlt: "BG" },
  { code: "sr", label: "Српски", flagType: "image", flagSrc: "flag-rs.svg", flagAlt: "RS" },
  { code: "sk", label: "Slovenčina", flagType: "image", flagSrc: "flag-sk.svg", flagAlt: "SK" },
  { code: "sl", label: "Slovenščina", flagType: "image", flagSrc: "flag-si.svg", flagAlt: "SI" },
  { code: "id", label: "Bahasa Indonesia", flagType: "image", flagSrc: "flag-id.svg", flagAlt: "ID" },
  { code: "th", label: "ไทย", flagType: "image", flagSrc: "flag-th.svg", flagAlt: "TH" },
  { code: "vi", label: "Tiếng Việt", flagType: "image", flagSrc: "flag-vn.svg", flagAlt: "VN" },
  { code: "ms", label: "Bahasa Melayu", flagType: "image", flagSrc: "flag-my.svg", flagAlt: "MY" },
  { code: "fil", label: "Filipino", flagType: "image", flagSrc: "flag-ph.svg", flagAlt: "PH" },
