    ...
    he: {
      ...
      features: {
        ...
        items: {
          ...
          history30Day: {
            title: "היסטוריית כניסות ל-30 יום",
            text: "צפו בפעילות הגישה של 30 הימים האחרונים וקבלו תמונה ברורה יותר של השימוש בשער ושל אירועי כניסה אחרונים.",
          },
          autoOpen: {
          ...
          rfRemoteLearning: {
            ...
            text: "למדו ונהלו שלטי RF באופן דיגיטלי דרך המערכת, במקום להסתמך על תהליכי תכנות ידניים ומנותקים.",
          },
          securityPrivacy: {
            title: "אבטחה ופרטיות",
            text: "נתוני הגישה נשארים מקומית על ההתקן, והמערכת מתוכננת סביב טיפול מאובטח, אחסון מוצפן ותפעול פרטי.",
          },
          noSubscriptionFees: {
            title: "ללא דמי מנוי",
