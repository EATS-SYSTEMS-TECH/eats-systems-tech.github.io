  ...
  const guestInvites = {
    ...
    he: {
      promo: {
        ...
        point3Title: "מוצפנת ופרטית",
        point3Text:
          "הגישה מוצפנת ומוגבלת לשער שהוגדר לה, כך שהנכס שלכם נשאר מוגן.",
      ...
      marketing: {
        ...
        audience: {
          label: "מיועד ל:",
          hotels: "מלונות",
          rentals: "Airbnb ודירות נופש",
          guesthouses: "בתי אירוח",
          parking: "חניות וגראג'ים להשכרה",
        },
        steps: {
          eyebrow: "איך זה עובד",
        ...
        benefits: {
          ...
          b3t: "מוצפנת ופרטית",
          b3x: "הגישה מוצפנת ומוגבלת להרשאה שהונפקה. הנכס והאורחים שלכם נשארים מוגנים.",
          ...
          b6x: "חברו את WIFIGATE Automation לתהליך ההזמנות, ל-PMS או ל-Channel Manager ותנו לזה לרוץ.",
        },
        secure: {
          eyebrow: "אבטחה",
          title: "גישה שאפשר לתת בביטחון גם לזרים",
          subtitle: "נבנתה כדי להגן על הנכס שמאחורי כל שער.",
          i1t: "מוצפנת מקצה לקצה",
          i1x: "כל הזמנה מוצפנת, כך שפרטי הגישה אינם ניתנים לקריאה או להעתקה בדרך.",
          i2t: "עובדת בשער, לא בענן",
          i2x: "הכניסה מאמתת את ההרשאה מול ההתקן עצמו, כך שהיא ממשיכה לעבוד גם ללא חיבור לאינטרנט.",
          i3t: "השליטה נשארת אצלכם",
          i3x: "הגישה צמודה לכל שהות ולכל אורח, ואתם יכולים לעצור אותה בכל רגע.",
        },
        pricing: {
          eyebrow: "תמחור",
          title: "מסלולים פשוטים לתוסף WIFIGATE Automation",
          ...
          starterF3: "גישה אוטומטית מוגבלת-בזמן",
          proDesc: "לחברת ניהול קטנה.",
          proF1: "עד 5 מערכות",
          proF2: "1,000 הזמנות לכל מערכת",
          proF3: "תמיכת אימייל מועדפת",
          hotelDesc: "למלון או מתחם שלם.",
          hotelF1: "עד 20 מערכות",
          hotelF2: "דוחות מרוכזים",
          hotelF3: "תמיכה מועדפת",
          enterpriseAmount: "מותאם",
          enterpriseDesc: "ל-PMS, ל-Channel Managers ולתיקי נכסים גדולים.",
          enterpriseF1: "תמחור נפח",
          enterpriseF2: "SLA והטמעה",
          enterpriseF3: "אינטגרציה מותאמת",
        },
        cta: {
          title: "מוכנים להפוך את גישת האורחים לאוטומטית?",
          text: "ספרו לנו על הנכסים שלכם ונתאים את WIFIGATE Automation לאופן שבו אתם מארחים.",
          button: "דברו איתנו",
        },
      },
    },
